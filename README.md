...
✨ Features
High-Precision Tm: Uses the SantaLucia (1998) Nearest-Neighbor method and von Ahsen (2001) salt correction for results accurate to within ±1°C of commercial software.
Modern UI: Clean, responsive interface with a Dark Mode toggle.
